...
plt.subplot(2,2,1)
plt.imshow(noisy_gau, 'gray'), plt.title('Gauss'), plt.xticks([]), plt.yticks([])
plt.subplot(2,2,2)
plt.imshow(noisy_sAp, 'gray'), plt.title('s&p'), plt.xticks([]), plt.yticks([])
plt.subplot(2,2,3)
plt.imshow(noisy_poi, 'gray'), plt.title('poisson'), plt.xticks([]), plt.yticks([])
plt.subplot(2,2,4)
plt.imshow(noisy_spe, 'gray'), plt.title('speckle'), plt.xticks([]), plt.yticks([])
